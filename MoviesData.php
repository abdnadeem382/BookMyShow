...
VALUES (1, 'Avengers Infinity War', 'https://cdn.europosters.eu/image/750/plastic-frame-avengers-infinity-war-one-sheet-i69678.jpg', '$time_str1', 'Robert Downey Jr. , Chris Hemsworth, Mark Ruffalo, Chris Evans, Scarlett Johansson, Tom Holland, Karen Gillan', 'Iron Man, Thor, the Hulk and the rest of the Avengers unite to battle their most powerful enemy yet -- the evil Thanos. On a mission to collect all six Infinity Stones, Thanos plans to use the artifacts to inflict his twisted will on reality. The fate of the planet and existence itself has never been more uncertain as everything the Avengers have fought for has led up to this moment', '$seats_str');";
$sql .= "INSERT INTO Movies (id, movie_name, poster, timings, cast, synopsis, seats)
